...
public:
    ...
    const std::string& getAudioOutputDevice() const { return getActiveProfile().audioOutputDevice; }
    bool getAutoStartAudio() const { return getActiveProfile().autoStartAudio; }
    bool getRememberDevices() const { return getActiveProfile().rememberDevices; }
    ...
    void setAudioOutputDevice(const std::string& device);
    void setAutoStartAudio(bool autoStart);
    void setRememberDevices(bool remember);
