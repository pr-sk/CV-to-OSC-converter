...
- **Kросс-платформенный GUI** (Qt/Dear ImGui/Electron)
- **Real-time visualization** CV сигналов with live waveforms
- **Drag-and-drop конфигурация** for easy channel management
- **Live parameter adjustment** without stopping conversion
- **Multi-window interface** with dockable panels
